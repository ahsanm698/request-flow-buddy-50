-- Complete database schema + seed data for the Employee Service Request app
-- Apply to a fresh Postgres/Supabase database in this exact order.

-- ================= drizzle/migrations/0000_workflow_core_schema.sql =================
-- ROLES
...
-- ================= drizzle/migrations/0001_attachment_storage_policies.sql =================
...
-- ================= drizzle/migrations/0002_first_user_admin_and_role_admin_policies.sql =================
