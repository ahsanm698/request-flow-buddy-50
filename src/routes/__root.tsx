  ...
  head: () => ({
    meta: [
      ...
      { title: "ServiceDesk — Employee Request & Approval Workflows" },
      {
        name: "description",
        content:
          "Internal portal for employee service requests with multi-step manager, HR and travel office approvals.",
      },
      { property: "og:title", content: "ServiceDesk — Employee Request & Approval Workflows" },
      {
        property: "og:description",
        content: "Raise, route and approve internal employee service requests.",
      },
